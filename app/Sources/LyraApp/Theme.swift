...
enum Bubble {
    ...
    /// 4pt spacing grid. Values are generated from `design/tokens.toml`
    /// ([space]) — edit there, then `make tokens`.
    enum Space {
        static let zero: CGFloat = 0
        // GENERATED SPACE — do not edit
    ...
    enum Size {
        ...
        /// Corner radii — generated from `design/tokens.toml` ([radius]).
        // GENERATED SIZE — do not edit
    ...
    /// Border line weights — generated from `design/tokens.toml` ([stroke]).
    enum Stroke {
        // GENERATED STROKE — do not edit
        static let fine: CGFloat = 1
        static let contrast: CGFloat = 2
        static let focus: CGFloat = 3
        static let inset: CGFloat = 3
        // END GENERATED STROKE
    }
    ...
    /// Type ramp point sizes — generated from `design/tokens.toml` ([type]).
    enum TypeSize {
